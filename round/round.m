...
%!assert (round ([0-13i 0-7i 0+0i 0+1i 0+2i 0+10i], 1, "decimals"), [0-13i     0-7i     0+0i     0+1i     0+2i    0+10i]);
%!assert (round ([-5090.543-13i -100-7i -3+0i 0+1i 1.11111+2i 8.8888884+10i], 1, "decimals"), [-5090.5-13i                        -100-7i                          -3+0i                           0+1i                         1.1+2i                  8.9+10i]);
...
%!assert (round ([-5090.543 -100 -3 0 1.11111 8.8888884], 2, "decimals"), [-5090.54           -100             -3              0           1.11      8.89]);
%!assert (round ([0-13i 0-7i 0+0i 0+1i 0+2i 0+10i], 2, "decimals"), [0-13i     0-7i     0+0i     0+1i     0+2i    0+10i]);
%!assert (round ([-5090.543-13i -100-7i -3+0i 0+1i 1.11111+2i 8.8888884+10i], 2, "decimals"), [-5090.54-13i                        -100-7i                          -3+0i                           0+1i                        1.11+2i                  8.89+10i]);
...
%!assert (round ([-5090.543 -100 -3 0 1.11111 8.8888884], 2, "significant"), [-5100           -100             -3              0            1.1      8.9]);
%!assert (round ([0-13i 0-7i 0+0i 0+1i 0+2i 0+10i], 2, "significant"), [0-13i     0-7i     0+0i     0+1i     0+2i    0+10i]);
